...
// Social links
const instagramLink = "https://www.instagram.com/iconicdentaldesigns";
const facebookLink = "https://www.facebook.com/iconicdentaldesigns";
const linkedinLink = "https://www.linkedin.com/company/100161122/admin/page-posts/published/";

const logo = "https://res.cloudinary.com/dbwuxxypx/image/upload/footer_logo_iercur.png"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-8 md:gap-6 lg:gap-8">
          ...
          <div className="sm:col-span-2 lg:col-span-4 ml-4">
            ...
            <div className="flex space-x-3 md:space-x-4 mt-4 md:mt-6">
              <Link href={facebookLink} aria-label="Facebook" className="hover:opacity-80 transition-opacity">
              ...
              <Link href={instagramLink} aria-label="Instagram" className="hover:opacity-80 transition-opacity">
                <div className="bg-white w-7 h-7 sm:w-8 sm:h-8 flex items-center justify-center rounded-sm">
                  <Instagram size={18} className="text-teal-700" />
                </div>
              </Link>
              <Link href={linkedinLink} aria-label="LinkedIn" className="hover:opacity-80 transition-opacity">
                <div className="bg-white w-7 h-7 sm:w-8 sm:h-8 flex items-center justify-center rounded-sm">
          ...
          <div className="sm:col-span-2 lg:col-span-4 grid grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 md:space-y-3 text-sm">
                ...
                <li>
                  <Link href="/privacy-policy" className="hover:underline transition-all">Privacy & Policy</Link>
                </li>
                <li>
            ...
            <div className="space-y-2 md:space-y-4">
              ...
              <div>
                ...
                <div className="flex items-center flex-wrap">
                  <a href="tel:+16478028420" className="flex items-center hover:opacity-80 transition-opacity">
                    ...
                    <span className="text-sm sm:text-base">+1 (647) 802-8420</span>
                  </a>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex items-center flex-wrap">
                  <a href="mailto:Info@iconicdentaldesign.com" className="flex items-center hover:opacity-80 transition-opacity">
                    <div className="bg-white p-1.5 sm:p-2 rounded-md mr-2 sm:mr-3">
                      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="sm:w-6 sm:h-6">
              ...
              <div>
                ...
                <a 
                  href="https://www.google.com/maps/search/?api=1&query=17131-53+Ave+NW+Edmonton+AB+T5T+2K1" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="flex items-start flex-wrap hover:opacity-80 transition-opacity"
                >
