            ...
            <main className="min-h-screen bg-white">
                <div className="mx-auto max-w-6xl px-6 py-16 md:py-24 lg:px-8">
                    ...
                    <div className="mb-12 text-center font-['Poppins']">
                        <h1 className="text-3xl font-bold text-[#07796B] md:text-4xl lg:text-5xl font-['Poppins']">Privacy Policy</h1>
                    </div>
                    ...
                    <div className="space-y-8 text-gray-700">
                        ...
                        <div className=" text-[#808586]">
                            <h2 className="mt-6 mb-6 text-xl font-bold text-[#636571] md:text-2xl">Collection of personal information</h2>
                        ...
                        <div className=" text-[#808586]">
                            <h2 className="mt-6 mb-6 text-xl font-bold text-[#636571] md:text-2xl">Sharing of your personal information</h2>
                        ...
                        <div className=" text-[#808586]">
                            <h2 className="mt-6 mb-6 text-xl font-bold text-[#636571] md:text-2xl">Use of Personal Information</h2>
                            <span className="leading-relaxed">
                            ...
                            <br />
                            <span>The personal information you provide will be kept confidential unless otherwise stated and used to support your customer relationship with Iconic Dental Design Studio. Among other things, we want to help you quickly find information on this site and alert you to product upgrades, new documentation, updated web information, and other new products, services, and special offers from Iconic Dental Design Studio.</span>
                        </div>

                        {/* Changes to this Privacy Policy */}
                        <div className=" text-[#808586]">
                            <h2 className="mt-6 mb-6 text-xl font-bold text-[#636571] md:text-2xl">Changes to this Privacy Policy</h2>
                            <p className="leading-relaxed">
                        ...
                        <div className=" text-[#808586]">
                            <h2 className="mt-6 mb-6 text-xl font-bold text-[#636571] md:text-2xl">Accessing your Personal Information</h2>
                            <p className="leading-relaxed">
                        ...
                        <div className=" text-[#808586]">
                            <h2 className="mt-6 mb-6 text-xl font-bold text-[#636571] md:text-2xl">Who does this Privacy Policy apply to?</h2>
                        ...
                        {/* Contacting us */}
                        <div className=" text-[#808586]">
                            <h2 className="mt-6 mb-6 text-xl font-bold text-[#636571] md:text-2xl">Contacting us</h2>
